...
if __name__ == "__main__":
    ...
    for i in range(num_loops):
        ...
        log_w = log_dN_vals - jnp.log(pdraw) +jnp.log(cosmo.dVCdz(df_pd['z'].values)) -2*jnp.log1p(df_pd['z'].values)- jnp.log(cosmo.ddL_dz(df_pd['z'].values)) 
        ...
        if i==0:
            df_det.to_hdf('con2_testw.h5', key='true_parameters', mode='a', format='table', append=False)
        else:
            df_det.to_hdf('con2_testw.h5', key='true_parameters', mode='a', format='table', append=True)
