...
def get_deterministic_parameters(sample, use_low_bump=True):
    ...
    if use_low_bump:
        if 'logit_flow' in sample:
            ...
            # Prefer log_fpeak; print once (utils holds the flag).  This
            # function is jitted, so the print runs at trace time only.
            ...
            # See notes/2026-08-09-log-fpeak-parametrization.md; must stay in
            # sync with intensity_models_fast.get_deterministic_parameters.
