...
if __name__ == "__main__":
    ...
    obs_file = '../src/data/obsc2_zm55_dlerr.h5'
    sel_file = '../src/sel_c2_zm55_dlerr.h5'
    pe_file='../src/pe_c2_zm55_dlerr.h5'
    ndet=1
    write_obs=True
    new_sel=True
    if ndet>0:
