...
if __name__ == "__main__":
    ...
    # Fraction of the selection HDF5 to use (prefix of rows).  Default 1.0
    # uses the full set.  Set sel_fraction=0.5 for the historical half-set
    # convention (first half of sel rows, ndraw/2).
    sel_fraction = run.getfloat("sel_fraction", fallback=1.0)
