...
# selection-pdraw-scale implementation (merge commit a0d74a4), truth point,
# 4 reduction-order permutations + float64 reference leg.
...
srun /mnt/home/misi/src/GW_pop_cosmo_inference/.venv/bin/python \
    test_float32_accuracy.py --recenter --point truth
